...
export default function Checkout(props: PropsWithChildren) {
  ...
  function checkoutHandler() {
    ...
    // setLoading(true);
    const { fullName, phone, address, email, cardName, cardNumber, month, year, cvv } = formEl.current!;
    console.log("cardName, cardNumber, cvv ", cardName.value, cardNumber.value, month.value, year.value, cvv.value);
      ...
      <section className="container py-5 fst-italic">
        ...
        <div className="row g-0">
          <form className="pe-md-5 ps-0 pt-0 col-12 col-md-7" ref={formEl}>
            ...
            <h5 className="fw-bolder text-black mb-4 my-5">PAYMENT INFO</h5>
            <div className='row'>
            ...
            <button
              ...
              type="button"
              className="btn btn-dark btn-block fw-light text-1 text-light w-100"
